  ...
  <table class="table table-striped">
    ...
    $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
      ...
      <tr>
        ...
        <td><a href="delete_score.php?id_sc=<?php echo $objResult1["id_score"];?>">ลบ</a></td>   
      </tr>
    <?php
        }
    ?>
...
<div class="container" align="center">
<div class="container"><a href="../../admin_page.php">หน้าหลักผู้ดูแลระบบ</a></div>
</div>
</body>
</html>